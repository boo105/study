...
# Stopwords 지정.
stop_words = ['game', 'time', 'server', 'getting', 'pubg', 'next', 'this', 'gamei', 'get', 'please', 'battlegrounds',
              'stuff', 'region', 'playerunknown', 'bluehole', 'chinese', 'chinaregion', 'ng', 'engine', 'got', 'im',
              't', 'xd', 'ram', 'tho', 'asian', 'but', 'busyservers', 'crash', 'no', 'of', 'so', 'me', 'don', 'too',
              'for', 'you', 'my', 'gamethe', 'na', 'd', 'devs', 'ur', 'can', 'graphic', 'pc', 'the', 'able', 'a',
              'negative', 'due', 's', 'steam', 'regionlockchina', 'stupid', 'complaining', 'in', 'it', 'china',
              'computer', 'lag', 'problem', 'gameit', 'are', 'poor', 'itit', 'lack', 'hacking', 'iti', 'anti', 'and',
              'gtx', 'to', 'is', 'br', 'ive', 'terrible', 'gear', 'wrong', 'pubg', 'lot', 'access', 'pc', 'thing',
              'something', 'bluehole', 'im', 'battleground', 'battlegrounds', 'regionlockchina', 'playerunknown', 'is',
              'issue', 'the', 'dont', 'lot', 'gtx', 'bluehole', 'alot', 'end', 'access', 'devs', 'fix', 'hacker', 'to',
              'hek', 'br', 'beta', 'hate', 'my', 'too', 'im', 'one', 'someone', 'issue', 'please', 'development', 'na',
              'every', 'trash', 'be', 'br', 'it', 'log', 'im', 'iti', 'pc', 'this', 'to', 'pubg', 'a', 'review', 'lot',
              'access', 'year', 'guy', 'steam', 'playerunknown', 'bluehole', 'thing', 'china', 'one', 's', 'na', 'you',
              'e', 'don', 'too', 'for', 'cheater', 'battlegrounds', 'gtx', 'dont', 'hardware', 'on', 'devs', 'bugs',
              'blue', 'n', 'ban', 'can', 'eu', 'cheating', 'l', 'dude', 'h', 'v', 'kinda', 'your', 'i7', 'would',
              'ping', 'be', 'xd', 'ton', 'of', 'f', 'cant', 'but', 'af', 'garbage', 'trash', 'hole', 'its', 'till',
              'cheat', 'alpha', 'developer', 'test', 'win', 'gon', 'gameif', 'cpu', 'numba', 'pace', 'choice', 'pls',
              'line', 'laggy', 'cod', 'r', 't', 'p', 'minute', 'network', 'ng', 'cs', 'regionlockchina', 'dev', 'man',
              'the', 'in', 'me', 'g', 'k', 'gameyou', 'bp', 'gameit', 'is', 'u', 'my', 'are', 'br', 'it', 'hek',
              'gamei', 'number', 'alot', 'ram', 'bit', 'just', 'chinaregion', 'd', 'buggy', 'com', 'i5', 'none', 'doot',
              'issue', 'hacker', 'hate', 'gamethe', 'gamebut', 'so', 'busyservers', 'bad', 'gpu', 'all', 'rig',
              'desync', 'z', 'chinese', 'list', 'let', 'hey', 'games', 'isnt', 'value', 'okay', 'cons', 'do', 'with',
              'crap', 'specs', 'no', 'sometimes', 'instead', 'yet', 'also', 'ok', 'far', 'ever', 'nothing', 'bug',
              'still', 'hard', 'very', 'always', 'way', 'much', 'lock', 'however', 'even', 'many', 'away', 'already',
              'frustration', 'not', 'otherwise', 'little', 'seriously', 'reviews', 'difficult', 'tl', 'gay', 'never',
              'often', 'gameits', 'gamein', 'critical', 'therethe', 'lots', 'everywhere', 'similar', 'useless', 'error',
              'early', 'last']
    ...
    def count_words(self, training_set):
        ...
        for doc, label in training_set:
            ...
            if self.isNumber(doc) is False:
                ...
                words_nnp = [word for word, pos in data_pos if
                             pos in ['NN', 'NNP', 'VBG', 'JJ', 'JJS', 'JJR', 'RB', 'RBS', 'RBR']]
...
# 감성 사전 구축 과정
# 긍정 토픽
ps_comment = ['good', 'fun', 'great', 'really', 'better', 'best', 'pretty', 'amazing', 'awesome', 'awsome', 'early',
              'well', 'goodgame', 'gg', 'fantastic', 'enjoyable', 'wow', 'favourite', 'happy', 'love', 'exciting',
              'favorite', 'hilarious', 'adrenaline', 'interesting', 'excellent']
ps_charctor = ['battleroyale', 'competetive', 'real', 'realistic', 'addictive', 'hardcore', 'strategic', 'military',
               'faster', 'pvp', 'massive']
ps_style = ['battle', 'fps', 'royale', 'gameplay', 'combat', 'random', 'war', 'hide', 'wearing', 'eating', 'hunting',
            'hitting', 'hiding', 'loot', 'shooter', 'aim', 'aiming', 'survival', 'running', 'picking', 'kill',
            'killing']
ps_feature = ['sniping', 'shot', 'map', 'bike', 'squad', 'inventory', 'dinner', 'chicken', 'scope', 'box', 'biggest',
              'miltiple', 'customization', 'weapon', 'winner', 'clothing', 'fpp', 'circle', 'rating', 'zone']
...
# 부정 토픽
ne_comment = ['bad', 'worst', 'waste', 'unreal', 'problem', 'trash', 'trerrible', 'wrong', 'stupid', 'crash',
              'ridiculous', 'garbage', 'refund', 'serious', 'anymore', 'never', 'sad', 'bye', 'boring', 'horrible']
ne_envoir = ['server', 'bug', 'lag', 'laggy', 'optimization', 'unplayable', 'matchmaking', 'waiting']
ne_another = ['chinese', 'region', 'regionlock', 'lock', 'regionlockchina', 'china', 'cheat', 'cheating', 'hack', 'dev',
              'development', 'fixing']
...
def positvie_review(doc):
    ...
    print(
        '-------------------------------------------------------토픽별 점수--------------------------------------------------------')
    print('게임평  : ' + str(comment) + '  | 게임성격 : ' + str(charctor) + '  | 게임스타일 : ' + str(style) + '  | 게임요소 : ' + str(
        feature) + '  | 그래픽 : ' + str(graphic) + '  | 타게임 : ' + str(othergame) + '  | 그외 : ' + str(antoher))
